...
def extract_frames(video_path, output_folder, include_parent=False, image_format="jpeg"):
    ...
    if include_parent:
        ...
        frame_folder = os.path.join(output_folder, 'New images')
    ...
    while True:
        ...
        # Save the frame as an image in JPEG format
        frame_path = os.path.join(frame_folder, f"frame_{frame_count:04d}.jpeg")
